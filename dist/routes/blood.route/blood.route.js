...
var _blood = _interopRequireDefault(require("../../controllers/blood.controller/blood.controller"));
...
router.route('/').get(_blood["default"].getBloods).post(_blood["default"].validateAddBlood(), _blood["default"].addBlood);
router.put("/cancel", _blood["default"].setCancelBlood); // router.post( '/carSignUp',userController.validateCarCreateBody(), userController.carSignUp);
