...
var _exchange = _interopRequireDefault(require("../../controllers/exchange.controller/exchange.controller"));
...
router.route('/').get(_exchange["default"].getExchanges).post(_exchange["default"].validateAddExchange(), _exchange["default"].addExchange).put(_exchange["default"].validateUpdateExchange(), _exchange["default"].updateExchange);
router.put("/cancel", _exchange["default"].setCancelExchange); // router.post( '/carSignUp',userController.validateCarCreateBody(), userController.carSignUp);
