...
var bloodSchema = new _mongoose.Schema({
  _id: {
    type: Number,
    required: true,
    "default": 0
...
bloodSchema.plugin(_mongooseI18nLocalize["default"], {
  locales: ['en', 'ar']
});
bloodSchema.plugin(autoIncrementSQ, {
  id: "blood_id",
  inc_field: "_id"
});

var _default = _mongoose["default"].model('blood', bloodSchema);
