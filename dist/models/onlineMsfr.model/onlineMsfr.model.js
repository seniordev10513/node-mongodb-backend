...
var oMsfrSchema = new _mongoose.Schema({
  _id: {
    type: Number,
    required: true,
    "default": 0
...
oMsfrSchema.plugin(_mongooseI18nLocalize["default"], {
  locales: ['en', 'ar']
});
oMsfrSchema.plugin(autoIncrementSQ, {
  id: "oMsfr_id",
  inc_field: "_id"
});

var _default = _mongoose["default"].model('onlineMsfr', oMsfrSchema);
