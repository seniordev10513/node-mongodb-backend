...
var BandedSchema = new _mongoose.Schema({
  _id: {
    type: Number,
    required: true,
    "default": 0
...
BandedSchema.plugin(_mongooseI18nLocalize["default"], {
  locales: ['en', 'ar']
});
BandedSchema.plugin(autoIncrementSQ, {
  id: "banded_id",
  inc_field: "_id"
});

var _default = _mongoose["default"].model('banded', BandedSchema);
