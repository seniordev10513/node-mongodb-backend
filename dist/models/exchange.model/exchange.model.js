...
var exchangeSchema = new _mongoose.Schema({
  _id: {
    type: Number,
    required: true,
    "default": 0
...
exchangeSchema.plugin(_mongooseI18nLocalize["default"], {
  locales: ['en', 'ar']
});
exchangeSchema.plugin(autoIncrementSQ, {
  id: "exchange_id",
  inc_field: "_id"
});

var _default = _mongoose["default"].model('exchange', exchangeSchema);
