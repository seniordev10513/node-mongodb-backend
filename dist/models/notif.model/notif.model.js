...
var NotifSchema = new _mongoose.Schema({
  ...
  subjectType: {
    type: String //enum:['USER','CONTACTUS','ADMIN','ORDER','CHANGE_ORDER_STATUS','PROMOCODE','PRODUCT','TRADER','ASK_STORE']
...
var _default = _mongoose["default"].model('notif', NotifSchema);
