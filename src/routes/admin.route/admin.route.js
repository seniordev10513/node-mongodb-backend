...
router.post('/signin', userController.validateAdminSignin(), userController.AdminsignIn);
router.post('/verify-signin', userController.validateVerifyAdminSign(), userController.verifyAdminSignIn);
router.get('/cars', userController.getCars);
// router.get('/mand', userController.getMands);
router.route( '/carSignUp' ).get(userController.getCarSign).put( userController.acceptCarSign)
router.post('/band',userController.validateBandUser(),userController.bandUser)
